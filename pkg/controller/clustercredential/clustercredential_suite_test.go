...
import (
	...
	"k8s.io/cluster-registry/pkg/inject"
...
func TestBee(t *testing.T) {
	...
	RunSpecsWithDefaultAndCustomReporters(t, "ClusterCredential Suite", []Reporter{test.NewlineReporter{}})
}
...
var _ = BeforeSuite(func() {
	...
	defer GinkgoRecover()
	Eventually(func() interface{} { return arguments.ControllerManager.GetController("ClusterCredentialController") }).
		Should(Not(BeNil()))
	ctrl = arguments.ControllerManager.GetController("ClusterCredentialController")
})
